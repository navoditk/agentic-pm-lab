...
| Structured reference | Security master | Mock fixture | Identifier and issuer resolution | [`security_master.csv`](mock_structured/security_master.csv) | [Data layer](../docs/reference/REFERENCES.md#data-layer-and-provenance) |
