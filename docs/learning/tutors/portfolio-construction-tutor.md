...
*Companion to [`agents/portfolio-construction-tutor.md`](../../../agents/portfolio-construction-tutor.md). Read that first for the fast orientation; this document goes further. Self-check with `uv run agentic-pm-lab quiz portfolio-construction-tutor`.*
