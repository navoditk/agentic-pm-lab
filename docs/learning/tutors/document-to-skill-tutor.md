...
*Companion to [`agents/document-to-skill-tutor.md`](../../../agents/document-to-skill-tutor.md). Read that first for the fast orientation; this document goes further. Self-check with `uv run agentic-pm-lab quiz document-to-skill-tutor`.*
