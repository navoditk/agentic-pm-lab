...
*Companion to [`agents/copilot-canvas-mcp-tutor.md`](../../../agents/copilot-canvas-mcp-tutor.md). Read that first for the fast orientation; this document goes further. Self-check with `uv run agentic-pm-lab quiz copilot-canvas-mcp-tutor`.*
