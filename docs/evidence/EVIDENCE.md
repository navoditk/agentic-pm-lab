...
| GitHub Projects learning board | Project schema, linked repository, 21 roadmap items, two morning-review issues | [Project views overview screenshot](screenshots/github-project/github-project-views-overview.png) | Views created and overview captured; remove the roadmap repository filter before capturing complete Day 1–21 evidence |
