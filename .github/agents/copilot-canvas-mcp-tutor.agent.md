...
`docs/reference/REFERENCES.md#github-copilot-app-canvas-prompts-skills-custom-agents`, label public versus mock inputs, and end with one small
...
call paid services, access credentials, or make investment
recommendations.
