---
name: docs-agent
description: Keep docs/ARCHITECTURE.md and docs/ficc-glossary.md aligned with current implementation and terminology.
---
...
- Check whether a change affects `docs/ARCHITECTURE.md` first, then update
