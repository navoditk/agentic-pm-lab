...
4. "The judge agrees with our labels 92% of the time, so ship it." Ask for kappa and the label balance first; on a mostly-pass sample, a judge that passes everything agrees just as often.
