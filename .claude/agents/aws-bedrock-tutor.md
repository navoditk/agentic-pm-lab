...
Negative examples:
1. "Let Bedrock run the tools so we can drop governed_call." Reject: the model only requests tools; authorization stays in your code, as the lab shows.
