...
LAYER_PATTERNS = {
    ...
    # AgentCore's direct-code entrypoint lives in Runtime rather than beside
    # the domain agents. Count the local implementation; live AWS deployment
    # remains a separate, explicitly unclaimed evidence item.
    "AWS Bedrock AgentCore": ["src/runtime/agentcore_app.py"],
}
