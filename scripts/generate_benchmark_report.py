...
def render(benchmark: dict[str, Any], roles: dict[str, Any] | None = None) -> str:
    ...
    lines = [
        ...
        "",
        f"Observed exact-capstone providers: **{len(exact)}**. The Ollama result is a valuable historical learning run, but is explicitly not treated as an apples-to-apples result because it used a different question set.",
        "",
